...
namespace OrganicNutritionRecipes.Migrations
{
    ...
    [Migration("20220201164700_initialMigratios_6")]
    partial class initialMigratios_6
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganicNutritionRecipes.Data.HealthyFact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganicNutritionRecipes.Models.Nutrient", b =>
                {
                    ...
                    b.Property<string>("nutrient_type1")
                        .IsRequired()
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.HasDiscriminator<string>("nutrient_type1").HasValue("Nutrient");
                });
            ...
            modelBuilder.Entity("OrganicNutritionRecipes.Data.HealthyFact", b =>
                {
                    b.HasOne("OrganicNutritionRecipes.Data.Tag", "Tag")
                        .WithOne("HealthyFact")
                        .HasForeignKey("OrganicNutritionRecipes.Data.HealthyFact", "TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
